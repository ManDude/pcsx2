...
{
	static const u32 Size = 0x2E000000; // 160mb(base) + 96MB(extra needed to bring up to 128MB)
	...
	static const u32 EEmemOffset   = 0x00000000; // 128mb
	...
	static const u32 EErecOffset   = 0x16000000;

	// IOP recompiler code cache area (16 or 32mb)
	static const u32 IOPrecOffset  = 0x1A000000;

	// newVif0 recompiler code cache area (16mb)
	static const u32 VIF0recOffset = 0x1C000000;

	// newVif1 recompiler code cache area (32mb)
	static const u32 VIF1recOffset = 0x1E000000;

	// microVU1 recompiler code cache area (32 or 64mb)
	static const u32 mVU0recOffset = 0x22000000;

	// microVU0 recompiler code cache area (64mb)
	static const u32 mVU1recOffset = 0x26000000;
	...
	static const u32 bumpAllocatorOffset = 0x2A000000; // 16mb
}
